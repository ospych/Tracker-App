...
import com.example.fitnessapp.other.Constants.CANCEL_TRACKING_DIALOG_TAG
...
import com.example.fitnesstracker.ui.fragments.CancelTrackingDialog
...
class TrackingFragment : Fragment(R.layout.fragment_tracking) {
    ...
    private fun stopRun() {
        tvTimer.text = getString(R.string.tracking_fragment_timer)
    ...
    private fun updateTracking(isTracking: Boolean) {
        ...
        if (!isTracking && curTimeInMillis > 0L) {
            btnToggleRun.text = getString(R.string.tracking_fragment_start)
            btnFinishRun.visibility = View.VISIBLE
        } else if (isTracking) {
            btnToggleRun.text = getString(R.string.tracking_fragment_stop)
            menu?.getItem(0)?.isVisible = true
    ...
    private fun endRunAndSaveToDb() {
        map?.snapshot {bmp ->
            ...
            Snackbar.make(
                ...
                getString(R.string.tracking_fragment_save_success),
